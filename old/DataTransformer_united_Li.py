...
def makedata():
    ...
    np.save('data\\ABO+ABX_training_data_v002.npy', training_data)
    np.save('data\\ABO+ABX_training_labels_v002.npy', training_labels)
    np.save('data\\ABO+ABX_test_data_v002.npy', test_data)
    np.save('data\\ABO+ABX_test_labels_v002.npy', test_labels)
    print("Done")
