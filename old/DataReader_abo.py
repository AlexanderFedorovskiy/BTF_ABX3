...
def makedata():
    training_data, training_labels, test_data, test_labels = readrawfile("data\\dataset ABO Li v001.txt")
    savetofile(training_data, 'data\\ABO_training_data_v001')
    savetofile(training_labels, 'data\\ABO_training_labels_v001')
    savetofile(test_data, 'data\\ABO_test_data_v001')
    savetofile(test_labels, 'data\\ABO_test_labels_v001')
