...
# remove features
training_data = np.delete(training_data, [1, 2, 4], 2)
test_data = np.delete(test_data, [1, 2, 4], 2)
...
tuner = BayesianOptimization(
    ...
    directory='D:\\models\\ABX3 n xsi Bayes',
...
for iteration, model in enumerate(models):
    ...
    # if iteration == 1:
    #     model.save("M_abx3_n_ri_tr86.92ts91.07")
