...
# remove features
training_data = np.delete(training_data, [1, 4], 2)
test_data = np.delete(test_data, [1, 4], 2)
...
tuner = BayesianOptimization(
    ...
    directory='D:\\models\\ABX3+ABO3 n ri xsi Bayes',
...
for iteration, model in enumerate(models):
    ...
    # if iteration == 1:
    #     model.save("M_abx3+abo3_n_ri_xsi_tr96.63ts93.65")
